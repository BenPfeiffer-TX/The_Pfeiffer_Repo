...
%We've found our bact that need to be refit, now to, well, refit them
[Zangle2,Yangle2,C_loc2,C_height2,orient,bactdata,count_track] = EllipsFitter_refit(newB,heightmap,C_loc2,C_height2,Zangle2,Yangle2,refit);
toc
fprintf('Refitting should be done, time to check results!\n')
